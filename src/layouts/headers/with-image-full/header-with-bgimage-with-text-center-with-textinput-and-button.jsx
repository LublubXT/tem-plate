export function HeaderWithBGImageWithTextCenterWithTextInputAndButton() {
  return (
    <div className="w-full h-[90vh]" style={{ backgroundImage: 'url("bg-image.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
