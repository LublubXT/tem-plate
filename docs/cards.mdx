...
Before Hover Over
<Image src="./imgs/image-card.png" alt="Card" width="400" height="400" />

While Hovering Over
<Image src="./imgs/card1.png" alt="Card1" width="400" height="400" />

While hovering, bottom bar smoothly slides up to reveal content.
